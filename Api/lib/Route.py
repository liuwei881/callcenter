...
class FreectiMasterModel(Basebase):
    pass

class CallCenterMasterModel(Basebase):
    pass

class CallCenterSlaveModel(Basebase):
    pass
...
class RoutingSession(Session):
    def get_bind(self, mapper=None, clause=None):
        if mapper and issubclass(mapper.class_, FreectiMasterModel):
            return engines['freectimaster']
        elif mapper and issubclass(mapper.class_, CallCenterMasterModel):
            return engines['callcentermaster']
        elif mapper and issubclass(mapper.class_, CallCenterSlaveModel):
            return engines['callcenterslave']
        else:
            return engines[
                random.choice(['base'])
            ]
